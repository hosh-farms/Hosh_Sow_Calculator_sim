# -*- coding: utf-8 -*-
"""Hosh_sow_calculator_monthly

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hABm5fE6ATcIvNWKdg_gd6NSExuWDPgl
"""
...
# -------------------------------
# Sow Rotation Simulator with monthly grower sales
# -------------------------------
def sow_rotation_simulator(
    ...
    for month in range(1, months + 1):
        ...
        sold_pigs = 0
        revenue = 0
        # Monthly sale: sell batches that reached grower_end_month this month
        batches_to_sell = [b for b in batches if b['grower_end_month'] == month and not b['sold']]
